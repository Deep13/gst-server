            ...
            .then(result => {
                ...
                if (access_token) {
                    var raw = JSON.stringify({
                        ...
                        "user_gstin": "09AAAPG7885R002", //required from client-side
                        "data_source": "erp",
                        "transaction_details": {
                            "supply_type": "B2B"
                        },
                        "document_details": {
                            "document_type": "INV",
                            "document_number": "MIPL/101", // req
                            "document_date": new Date().toLocaleDateString()
                        },
                        "seller_details": {
                            "gstin": "09AAAPG7885R002",  // same as top
                            "legal_name": "MastersIndia UP", // r
                        ...
                        "dispatch_details": {
                            "company_name": "MastersIndia UP", // same as seller details
                            "address1": "Vila",// same as seller details
                            // "address2": "Vila",
                            "location": "Noida", // same as seller details
                            "pincode": 201301, // same as seller details
                            "state_code": "UTTAR PRADESH" // same as seller details
                        },
                        "ship_details": {
                            // "gstin": "05AAAPG7885R002",
                            "legal_name": "MastersIndia UT", // same as buyer details
                            // "trade_name": "MastersIndia UT",
                            "address1": "Kila", // same as buyer details
                            // "address2": "Kila",
                            "location": "Nainital", // same as buyer details
                            "pincode": 263001, // same as buyer details
                            "state_code": "UTTARAKHAND" // same as buyer details
                        },
                        // "export_details": {
                        //     "ship_bill_number": "",
                        ...
                        "reference_details": {
                            ...
                            "document_period_details": {
                                "invoice_period_start_date": new Date().toLocaleDateString(),
                                "invoice_period_end_date": new Date().toLocaleDateString(),
                            },
